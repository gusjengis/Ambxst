...
QtObject {
    ...
    readonly property var staticItems: [
        ...
        { label: "Show Layout Button", keywords: "keyboard layout selector hyprland", section: 8, subSection: "bar", subLabel: "Ambxst > Bar", icon: Icons.layout, isIcon: true },
        { label: "Show Special Workspaces", keywords: "special workspace pill toggle", section: 8, subSection: "bar", subLabel: "Ambxst > Bar", icon: Icons.layout, isIcon: true },
        { label: "Special Workspace Display", keywords: "icons names special workspace", section: 8, subSection: "bar", subLabel: "Ambxst > Bar", icon: Icons.layout, isIcon: true },
        { label: "Show Preset Button", keywords: "presets toggle visibility", section: 8, subSection: "bar", subLabel: "Ambxst > Bar", icon: Icons.layout, isIcon: true },
